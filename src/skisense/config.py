...
# SAM 3D Body settings (Meta, 2025). Weights are gated on HuggingFace;
# request access on https://huggingface.co/facebook/sam-3d-body-dinov3
# and authenticate locally with ``hf auth login`` before first run.
