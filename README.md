...
ズーム有効時は、肩中点と腰中点の中間を **胴体中心** として扱い、この点が毎フレーム画面中央に来るように crop する。倍率は固定値ではなく、対象スキーヤーの bbox 面積が出力フレーム面積の約 35% になるよう自動計算する。対象が画面端にいる場合は、元映像の端を複製して padding し、胴体中心の中央固定を優先する。
